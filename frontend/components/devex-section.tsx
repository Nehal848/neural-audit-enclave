...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the Elvon SDK" },
      { type: "command", text: "npm install @elvon/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx elvon init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@elvon/sdk'" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { VectorMemory } ", keyword2: "from", string: " '@elvon/memory'" },
      { type: "gap" },
  ...
  },
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Deploy to Elvon Cloud" },
      { type: "command", text: "elvon deploy --prod" },
      { type: "gap" },
      ...
      { type: "url", text: "  → https://agents.elvon.dev/researcher" },
    ],
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <div className="mt-4 inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-black/[0.05] border border-black/[0.06] text-[10px] tracking-widest text-black/40 uppercase">
            Hospital AI Infrastructure Platform
          </div>
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            Built for Hospitals.<br />Powered by Enterprise Intelligence.
          </h2>
        </div>
